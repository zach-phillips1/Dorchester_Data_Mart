...
COMMENT ON COLUMN stage.incident_stg.pcr_number IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.incident_number IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.unit_code IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.shift IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.crew_member_id_list IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.psap_call_time IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.dispatch_notified_time IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.unit_dispatch_time IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.unit_enroute_time IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.unit_arrival_time IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.unit_pt_contact_time IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.unit_left_scene_time IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.unit_arrive_dest_time IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.unit_toc_time IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.unit_in_service_time IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.unit_cancel_time IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.destination_name IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.destination_code IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.transport_disposition IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.dispatch_reason IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.dispatch_reason_with_code IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.primary_impression_code IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.primary_impression_desc IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.secondary_impression_code_list IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.secondary_impression_desc_list IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.level_of_care_provided IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.response_mode_to_scene IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.transport_mode_from_scene IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.dest_odometer_reading IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.scene_postal_code IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.who_canceled IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.incident_status IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.incident_validity_score IS $doc$
...
COMMENT ON COLUMN stage.incident_stg.last_modified IS $doc$
